...
export class Node {
    ...
    get posVec3() {return this.pos_}
    get pos() {return this.pos_}
    get id() {return this.id_}
    get halfedge() {return this.he_}
...
export class Facet {
    ...
    get halfedge() {return this.halfedge_}
    get degree() {
        let result = 0
    ...
    get nbEdges() {return this.degree}
    get nbNodes() {return this.degree}
    get isOnBorder() {
        let it = this.halfedge_
        do {
    ...
    get isTriangle() {return this.halfedge_.next.next.next === this.halfedge_}
    get id() {return this.id_}
    get opposite() {return this.halfedge_.opposite.facet}

    setId(i: number) {this.id_ = i}
    setHalfedge(h: Halfedge) {this.halfedge_=h}
...
export class Halfedge {
    ...
    get opposite() {return this.opposite_}
    get next() {return this.next_}
    get prev() {return this.prev_}
    get facet() {return this.facet_}
    get node() {return this.node_} // The end node
    ...
    get nextAroundNode() {return this.opposite.prev}
    get prevAroundNode() {return this.next.opposite}
    get isBorder() {return this.facet_ === undefined}
    get isBorderEdge() {return this.isBorder || this.opposite.isBorder}
    //get nextOnBorder() ;
    //get prevOnBorder() ;

    setOpposite(h: Halfedge) {this.opposite_=h}
    setNext(h: Halfedge) {this.next_=h}
    setPrev(h: Halfedge) {this.prev_=h}
    setFacet(f: Facet) {this.facet_=f}
    setNode(n: Node) {this.node_=n}
}
