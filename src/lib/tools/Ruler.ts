import { 
    Camera, CanvasTexture, EventDispatcher, LineBasicMaterial, Object3D,
	Scene, Sprite, SpriteMaterial, Vector2, WebGLRenderer,
	Raycaster, BufferGeometry, BufferAttribute, Line, Vector3
} from "three"
...
class RulerLine extends Line {
	...
	makeDistanceSprite() {
		...
		this.roundRect(ctx, margin, margin, canvas.width - margin * 2, canvas.height - margin * 2, 2);
